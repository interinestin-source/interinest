              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <Input id="password" name="password" type={showPassword ? "text" : "password"} required className="h-10 rounded-xl border-[#e2d6c3] bg-[#fdf9f2] pr-10 text-sm focus-visible:ring-[#7593b4]" placeholder="Enter a secure password" />
                    <button
                      type="button"
