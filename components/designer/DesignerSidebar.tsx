...
import {
  X, LogOut, Home, FolderOpen, LayoutGrid, User, Globe, HelpCircle, FolderPlus, CreditCard,
} from "lucide-react";
...
const navigation = [
  ...
  { name: "Plans & Pricing", path: "/dashboard/designer-dashboard/plans",      icon: CreditCard,   exact: false },
];
